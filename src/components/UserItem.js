    ...
    return (
        ...
        <div className="col-md-6 col-sm-6 col-xs-6 col-lg-3" style={{ marginTop: '10px' }}>
          <div className="card" style={{ padding:'10px' }}>
                <Link to={`/user/${login}`}><img src={avatar_url} className="img-thumbnail" style={{ Width: '100%', height: '260px', padding:'10px', margin:'auto', display:'block' }} alt="description" /></Link>
